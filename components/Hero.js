...
function Hero({ t }) {
  return (
    <div className="flex justify-center items-center px-8 md:px-0">
      ...
      <div className="w-[200px] h-[140px] sm:h-[250px] md:w-[300px] lg:w-[400px] lg:h-[300px] border-2 border-boxBorder absolute top-[170px] md:top-[140px] -right-[30px] md:right-[40px] z-0 " />
      <div className="w-[200px] h-[140px] md:w-[400px] md:h-[350px] border-2 border-boxBorder absolute top-[360px] -left-[100px] z-0 " />
      <div className="w-[200px] h-[140px] md:h-[200px] lg:w-[350px] lg:h-[300px] xl:w-[500px] xl:h-[400px] border-2 border-boxBorder absolute top-[550px] -left-[100px] md:top-[350px] md:left-[400px] xl:left-[500px] z-0 " />
      <div className="w-[240px] h-[300px] sm:w-[360px] border-2 border-boxBorder absolute top-[470px] xl:top-[540px] left-[140px] xl:left-[200px] z-0 " />
      ...
      <div className="w-[160px] h-[200px] sm:w-[240px] lg:w-[330px] lg:h-[440px] xl:w-[430px] border-2 border-boxBorder absolute top-[800px] lg:top-[730px] xl:top-[670px] xl:right-[100px] right-0 z-0" />
      ...
      <div className="z-10 w-full flex items-center justify-center">
        <div className="flex flex-col items-start w-full max-w-[500px] md:max-w-[640px] xl:max-w-[1080px] 2xl:max-w-[1280px] py-[70px] xl:pt-[200px] xl:pb-[320px] gap-y-[25px]">
          ...
          <h3 className="text-[16px] xl:text-[24px] text-subTwo">
            {t("common:heroSub")}
          </h3>
